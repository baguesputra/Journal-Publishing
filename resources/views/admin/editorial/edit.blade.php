                    ...
                    <form method="POST" action="{{ route('editorial.update', $data->id) }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                name="nama" value="{{ old('nama', $data->nama) }}" required autocomplete="nama" autofocus>
                        ...
                        <div class="form-group row">
                            <label for="jabatan" class="col-md-4 col-form-label text-md-right">{{ __('Positon') }}</label>

                            <div class="col-md-6">
                                <select name="jabatan" id="jabatan" class="form-control">
                                    <option value="" hidden selected>--Choose--</option>
                                    
                                    @foreach($select_jabatan as $jabatan)
                                    <option value="{{ $jabatan->id}}" {{$data->jabatan == $jabatan->id ? 'selected' : '' }}>{{ $jabatan->nama_jabatan}}</option>              
                                    @endforeach
                                    </select>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                name="tgl_lahir" value="{{ old('tgl_lahir', $data->tgl_lahir) }}" required autocomplete="tgl_lahir">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                name="instansi" value="{{ old('instansi', $data->instansi) }}" required autocomplete="instansi">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                name="negara" value="{{ old('negara', $data->negara) }}" required autocomplete="negara">
                         ...
                         <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                name="kota" value="{{ old('kota', $data->kota) }}" required autocomplete="kota">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                name="alamat" value="{{ old('alamat', $data->alamat) }}" required autocomplete="alamat">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                name="no_hp" value="{{ old('no_hp', $data->no_hp) }}" required autocomplete="no_hp">
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-6 offset-md-4">
                                ...
                                <a href="{{ route('editorial.index') }}" class="btn btn-md btn-danger">
