                    ...
                    <form method="POST" action="{{ route('author.update', $data->id) }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                name="tgl_lahir" value="{{ old('tgl_lahir', $data->tgl_lahir) }}" required autocomplete="instansi">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                name="nip" value="{{ old('nip', $data->nip) }}" required autocomplete="instansi">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                name="negara" value="{{ old('negara', $data->negara) }}" required autocomplete="instansi">
                         ...
                         <div class="form-group row">
                            <label for="kode_pos" class="col-md-4 col-form-label text-md-right">{{ __('Zip') }}</label>

                            <div class="col-md-6">
                                <input id="kode_pos" type="text" class="form-control @error('kode_pos') is-invalid @enderror" 
                                name="kode_pos" value="{{ old('kode_pos', $data->kode_pos) }}" required autocomplete="level_status">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                name="alamat" value="{{ old('alamat', $data->alamat) }}" required autocomplete="instansi">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                name="no_hp" value="{{ old('no_hp', $data->no_hp) }}" required autocomplete="email">
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-6 offset-md-4">
                                ...
                                <a href="{{ route('author.index') }}" class="btn btn-md btn-danger">
