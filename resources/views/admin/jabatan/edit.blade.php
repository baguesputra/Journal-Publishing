        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('position.update', $data->id) }}">
                        {{method_field('PUT')}}
                        @csrf

                        <div class="form-group row">
                            <label for="nama_jabatan" class="col-md-4 col-form-label text-md-right">{{ __('Position') }}</label>

                            <div class="col-md-6">
                                <input id="nama_jabatan" type="text" class="form-control @error('nama_jabatan') is-invalid @enderror" 
                                name="nama_jabatan" value="{{ old('nama_jabatan', $data->nama_jabatan) }}" required autocomplete="nama_jabatan">
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-6 offset-md-4">
                                ...
                                <a href="{{ route('position.index') }}" class="btn btn-md btn-danger">
