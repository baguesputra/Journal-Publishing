                ...
                <div class="card-body">
                    ...
                    <thead>
                        ...
                        <tr>
                            ...
                            <td>{{ $jabatan->ket}}</td>
                            <td  align="center">
                                <a href="{{ route('position.edit', $jabatan->id) }}" class="fa fa-edit" title="Edit" aria-hidden="true"></a> 
                            </td>   
                            <td  align="center">

                                 <form method="POST" id="delete" action="{{ route('position.destroy', $jabatan->id) }}">
                    ...
                    <div class="container">            
                        ...
                        <div class="pull-right"> 
                            <div class="col-sm">
                             ...
                             <a href="{{ route('position.create') }}" class="btn btn-success"><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-plus-circle-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
