                ...
                <div class="card-body">
                    ...
                    <thead>
                        ...
                        <tr>
                            ...
                            <span class="badge badge-pill badge-success">{{ $submission->status}}</span>
                            @elseif ($submission->status == 'Process')
                            <span class="badge badge-pill badge-secondary">{{ $submission->status}}</span>
                            @elseif ($submission->status == 'Review')
                            <span class="badge badge-pill badge-warning">{{ $submission->status}}</span>
                            @else
                            <span class="badge badge-pill badge-primary">{{ $submission->status}}</span>
                            @endif
                            </td>
                            <td  align="center">
                            ...
                            <td  align="center">
                                <a href="{{ route('submission.edit', $submission->id) }}" class="fa fa-edit" title="Edit" aria-hidden="true"></a> 
                            </td>   
                            <td  align="center">

                                 <form method="POST" id="delete" action="{{ route('submission.destroy', $submission->id) }}">
                    ...
                    <div class="container">            
                        <div class="row">
                        <div class="col-sm">
                        <a href="{{ route('schedule') }}" class="btn btn-warning ">Schedule</a>
                        </div>
                        ...
                        <div class="pull-right">
                            ...
                            <div id="myDropdown" class="dropdown-content">
                                <a href="{{ route('submission.report') }}">All</a>
                                <a href="{{ route('submission.cetak-form')}}">Per Date</a>
                            </div>
                        </div>
                              </div>
                        </div>

                        <div style="border: 1px groove; height: 50px; width: 0px;"> </div>
                       
                        <div class="pull-right"> 
                            <div class="col-sm">
        
                             <a href="{{ route('submission.create') }}" class="btn btn-success"><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-plus-circle-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
