                    ...
                    <form method="POST" action="{{ route('submission.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                name="pengaju" value="{{ old('pengaju') }}" required autocomplete="pengaju">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                name="tgl_pengajuan" value="{{ old('tgl_pengajuan') }}" required autocomplete="tgl_pengajuan">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                name="abstrak" value="{{ old('abstrak') }}" required autocomplete="abstrak">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                name="ruangg_lingkup" value="{{ old('ruang_lingkup') }}" >
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                name="kecukupan" value="{{ old('kecukupan') }}" >
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="kelengkapan" type="text" class="form-control " 
                                name="kelengkapan" value="{{ old('kelengkapan') }}" >
                        ...
                        <div class="form-group row">
                         ...
                         <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                name="komentar" value="{{ old('komentar') }}" ></textarea>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                name="jurnal" value="{{ old('jurnal') }}" required autocomplete="email">
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-6 offset-md-4">
                                <button type="submit" class="btn btn-primary" onclick="alert('Success')">
                                ...
                                <a href="{{ route('submission.index') }}" class="btn btn-md btn-danger">
