    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <div>Publish Submission</div>
                </div>

                <div class="card-body">
                    <form method="POST" action="{{ route('submission.storepublish', $data->id) }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                name="tgl_masuk" value="{{ old('tgl_masuk', $data->jadwal) }}" required autocomplete="tgl_pengajuan">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="hal" type="text" class="form-control @error('abstrak') is-invalid @enderror" 
                                name="hal" value="{{ old('hal') }}" required autocomplete="abstrak">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="tahun" type="text" class="form-control " 
                        ...
                        <div class="form-group row">
                            <label for="vol" class="col-md-4 col-form-label text-md-right">{{ __('Vol') }}</label>

                            <div class="col-md-6">
                                <input id="vol" type="text" class="form-control " 
                                name="vol" value="{{ old('vol') }}" >
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                name="jurnal" value="{{ old('document', $data->jurnal) }}" >
