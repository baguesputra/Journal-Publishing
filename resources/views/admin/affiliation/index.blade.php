        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="col-sm">
                        <form action="{{ route('search.affiliation')}} " action="GET">
                ...
                <div class="card-body">
                    ...
                    <thead>
                        ...
                        <tr>
                            ...
                            <td  align="center">
                                <a href="{{ route('affiliation.report.perdata', $affiliation->id)}}" class="fa fa-print" title="Report" style="color:grey"></a> 
                            </td>
                            <td  align="center">
                                <a href="{{ route('affiliation.show', $affiliation->id)}}" class="fa fa-info" title="Details" aria-hidden="true" style="color:yellow"></a> 
                            </td>
                            <td  align="center">
                                <a href="{{ route('affiliation.edit', $affiliation->id) }}" class="fa fa-edit" title="Edit" aria-hidden="true"></a> 
                            </td>   
                            <td  align="center">

                                 <form method="POST" id="delete" action="{{ route('affiliation.destroy', $affiliation->id) }}">
                    ...
                    <div class="container">            
                        ...
                        <div class="pull-right">
                            <div class="col-sm">
                                <a href="{{ route('affiliation.report')}}" class="btn btn-secondary">
                        ...
                        <div class="pull-right"> 
                            <div class="col-sm">
                             ...
                             <a href="{{ route('affiliation.create') }}" class="btn btn-success delete"><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-plus-circle-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
