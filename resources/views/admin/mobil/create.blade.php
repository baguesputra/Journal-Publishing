    ...
    @csrf
                <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                name="no_plat" value="{{ old('no_plat') }}" required autocomplete="judul" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                name="tipe" value="{{ old('tipe') }}" required autocomplete="judul" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                name="jenis" value="{{ old('jenis') }}" required autocomplete="judul" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                name="foto" value="{{ old('foto') }}" required autocomplete="judul" autofocus>
