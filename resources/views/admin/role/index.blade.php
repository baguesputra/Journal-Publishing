                ...
                <div class="card-body">
                    ...
                    <thead>
                        ...
                        <tr>
                            ...
                            <td>{{ $role->ket}}</td>
                            <td  align="center">
                                <a href="{{ route('role.edit', $role->id) }}" class="fa fa-edit" title="Edit" aria-hidden="true"></a> 
                            </td>   
                            <td  align="center">

                                 <form method="POST" id="delete" action="{{ route('role.destroy', $role->id) }}">
                    ...
                    <div class="container">            
                        ...
                        <div class="pull-right"> 
                            <div class="col-sm">
                             ...
                             <a href="{{ route('role.create') }}" class="btn btn-success"><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-plus-circle-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
