                ...
                <div class="card-body">
                    ...
                    <thead>
                        ...
                        <tr>
                            ...
                            <td>{{ $affiliation->subjek}}</td>
                           
                            <td>{{ $affiliation->pesan}}</td>
                            <!-- <td  align="center">
                                <a href="" class="fa fa-print" title="Report" style="color:grey"></a> 
                            </td> -->
                            <td  align="center">
                                <a href="{{ route('contact.show', $affiliation->id)}}" class="fa fa-info" title="Details" aria-hidden="true" style="color:yellow"></a> 
                            </td>
                            <!-- <td  align="center">
                                <a href="{{ route('contact.edit', $affiliation->id) }}" class="fa fa-paper-plane" title="Edit" aria-hidden="true"></a> 
                            </td>    -->
                            <td  align="center">

                                 <form method="POST" id="delete" action="{{ route('contact.destroy', $affiliation->id) }}">
                    ...
                    <div class="container">            
                        ...
                        <div class="pull-right">
                            <div class="col-sm">
                                <a href="{{ route('contact.report')}}" class="btn btn-secondary">
                        ...
                        <div class="pull-right"> 
                            <div class="col-sm">
                             ...
                             <!-- <a href="" class="btn btn-success delete"><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-plus-circle-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
