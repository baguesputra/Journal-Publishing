        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('affiliation.update', $data->id) }}">
                        {{method_field('PUT')}}
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                name="kode" value="{{ old('kode', $data->kode) }}" required autocomplete="kode">
                        ...
                        <div class="form-group row">
                         ...
                         <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                name="website" value="{{ old('website', $data->website) }}" required autocomplete="website">
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-6 offset-md-4">
                                ...
                                <a href="{{ route('affiliation.index') }}" class="btn btn-md btn-danger">
