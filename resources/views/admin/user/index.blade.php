        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="col-sm">
                        <form action="{{ route('search.user')}}" action="GET">
                ...
                <div class="card-body">
                    ...
                    <thead>
                        ...
                        <tr align="center">
                            ...
                            <td  align="center">
                                <a href="{{ route('user.edit', $user->id) }}" class="fa fa-edit" title="Edit" aria-hidden="true"></a> 
                            </td>   
                            <td  align="center">
                    ...
                    <div class="container">            
                        ...
                        <div class="pull-right"> 
                            <div class="col-sm">
                             ...
                             <a href="{{ route('user.create') }}" class="btn btn-success"><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-plus-circle-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
