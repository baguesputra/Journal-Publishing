                    ...
                    <form method="POST" action="{{ route('user.update', $data->id) }}">
                        ...
                        <div class="form-group row">
                            ...
                            <select name="level" id="level" class="form-control">
                                ...
                                <option value="{{ $role->id}}" {{$data->level == $role->id ? 'selected' : '' }}>{{ $role->nama_role}}</option>
                                @endforeach
                                </select>
                                @error('level')
                                    <span class="invalid-feedback" role="alert">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="password" type="password" id="pwd" class="form-control @error('password') is-invalid @enderror" 
                                name="password" value="{{ old('password', $data->password) }}" required autocomplete="new-password" data-toggle="password">
