            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item">
                                <a class="nav-link" href="" style="color:white;">Editorial Board</a>
                        </li>
                        <li class="nav-item">
                                <a class="nav-link" href="" style="color:white;">Guidelines</a>
                        </li>
                        <li class="nav-item">
                                <a class="nav-link" href="" style="color:white;">Archives</a>
                        </li>
                        <li class="nav-item">
                                <a class="nav-link" href="" style="color:white;">Conferences</a>
                        </li>
                        <li class="nav-item">
