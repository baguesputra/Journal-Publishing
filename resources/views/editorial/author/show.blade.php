                    ...
                    <form method="POST" action="">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                name="nip" value="{{ old('nip', $data->nip) }}" required autocomplete="nip" disabled>
                        ...
                        <div class="form-group row">
                         ...
                         <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                name="kode_pos" value="{{ old('kode_pos', $data->kode_pos) }}" required autocomplete="kode_pos" disabled>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                name="no_hp" value="{{ old('no_hp', $data->no_hp) }}" required autocomplete="email" disabled>
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-6 offset-md-4">
                                ...
                                <a href="{{ route('editorial.author') }}" class="btn btn-md btn-danger">
