        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="col-sm">
                        <form action="{{ route('editorial.search.author') }}" action="GET">
                ...
                <div class="card-body">
                    ...
                    <thead>
                        ...
                        <tr>
                            ...
                            <td>{{ $author->email}}</td>
                            <td  align="center">
                                <a href="{{ route('editorial.author.report.perdata', $author->id)}}" class="fa fa-print" title="Report" style="color:grey"></a> 
                            </td>
                            <td  align="center">
                                <a href="{{ route('editorial.author.show', $author->id)}}" class="fa fa-info" title="Details" aria-hidden="true" style="color:yellow"></a> 
                            </td>
                    ...
                    <div class="container">            
                        ...
                        <div class="pull-right">
                            <div class="col-sm">
                                <a href="{{ route('editorial.author.report')}}" class="btn btn-secondary">
