                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select name="penulis" id="penulis" class="form-control" disabled>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                name="tgl_masuk" value="{{ old('tgl_masuk', $data->tgl_masuk) }}" 
                                required autocomplete="tgl_masuk" disabled>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                name="document" value="{{ old('document') }}" required autocomplete="email" disabled>
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-6 offset-md-4">
                                ...
                                <a href="{{ route('editorial.archive') }}" class="btn btn-md btn-danger">
