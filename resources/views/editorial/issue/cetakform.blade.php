                    ...
                    <!-- <form method="POST" action="{{ route('archive.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-6 offset-md-4">
                                <a href="" class="btn btn-secondary" onclick="this.href='cetak-filter/'+ document.getElementById('tglawal').value + '/' + document.getElementById('tglakhir').value ">
                                <i class="fa fa-print"></i>Print</a>

                                <a href="{{ route('editorial.issue') }}" class="btn btn-md btn-danger">
