                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('submission.update', $data->id) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select name="user_id" id="user_id" class="form-control" disabled hidden>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                name="ruang_lingkup" value="{{ old('ruang_lingkup', $data->ruang_lingkup) }}" disabled>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                name="nilai" value="{{ old('nilai', $data->grade) }}" disabled>
                         ...
                         <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                name="komentar" value="{{ old('komentar', $data->komentar) }}" disabled></textarea>
