        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('reviewer.submission.update', $data->id) }}" enctype="multipart/form-data">
                        {{method_field('PATCH')}}
                        @csrf

                        <div class="form-group row">
                            <label for="user_id" class="col-md-4 col-form-label text-md-right" hidden>{{ __('User Id') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="pengaju" class="col-md-4 col-form-label text-md-right" hidden>{{ __('Author') }}</label>

                            <div class="col-md-6">
                                <input id="pengaju" type="text" class="form-control @error('pengaju') is-invalid @enderror" 
                                name="pengaju" value="{{ old('pengaju', $data->pengaju) }}" required autocomplete="pengaju" hidden>
                        ...
                        <div class="form-group row">
                            <label for="ruang_lingkup" class="col-md-4 col-form-label text-md-right">{{ __('Scope') }}</label>

                            <div class="col-md-6">
                                <input id="ruang_lingkup" type="text" class="form-control " 
                                name="ruang_lingkup" value="{{ old('ruang_lingkup', $data->ruang_lingkup) }}" >
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                name="nilai" value="{{ old('nilai', $data->nilai) }}" >
                         ...
                         <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                name="komentar" value="{{ old('komentar', $data->komentar) }}" >{{ $data->komentar }}</textarea>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="jurnal" type="file" class="form-control " 
                                name="jurnal" value="{{ old('jurnal', $data->jurnal) }}">
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-6 offset-md-4">
                                ...
                                <a href="{{ route('reviewer.submission') }}" class="btn btn-md btn-danger">
