...
use App\Affiliation;
use App\User;
class LoginEditorialController extends Controller
{
    public function index(){
        ...
        return view('editorial.index', compact('author','archive','editorial','issue','reviewer','submission','affiliation','user'));
